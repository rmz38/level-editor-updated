...
const Capsule : React.FC<Props> = ({info, update, selected, id, copy, world}) => {
  ...
  return (
    <div >
      <ButtonGroup style = {{width: '100%'}}>
        ...
        <Button color="success" onClick = {() => copy(updatedState(), time(spaceState) + "_capsule",'capsule')} style = {{marginBottom: '1rem'}}>Copy</Button>
